...
time_and_distance_averages <- df2 %>% 
  ...
  summarize(mean_rt=mean(ride_time), med_rt=median(ride_time), 
            mean_rd=mean(ride_distance), med_rd=median(ride_distance))
time_and_distance_averages %>% 
  ggplot(aes(x=member_casual, y=mean_rt, fill=member_casual)) +
  labs(y="average ride time") +
  geom_col()
time_and_distance_averages %>% 
  ggplot(aes(x=member_casual, y=med_rt, fill=member_casual)) +
  labs(y="median ride time") +
  geom_col()
time_and_distance_averages %>% 
  ...
  geom_col()
time_and_distance_averages %>% 
  ggplot(aes(x=member_casual, y=med_rd, fill=member_casual)) +
  labs(y="median ride distance") +
  geom_col()
```
